module RodTheBot
  ...
  class Scheduler
    ...
    def season_stats_with_rank
      ...
      faceoff_percentage = team_stats["faceOffWinPercentage"]
      average_goals_scored = team_stats["goalsPerGame"]
      average_goals_allowed = team_stats["goalsAgainstPerGame"]
      shots_per_game = team_stats["shotsPerGame"]
      shots_allowed_per_game = team_stats["shotsAllowed"]
      shooting_percentage = team_stats["shootingPctg"]
      power_play_percentage = team_stats["powerPlayPercentage"]
      penalty_kill_percentage = team_stats["penaltyKillPercentage"]
