module RodTheBot
  class EdgeTeamSpeedWorker
    ...
    def perform(game_id = nil)
      ...
      retry_job(e, game_id: game_id, operation: "edge_team_speed")
    end
    ...
    def fetch_opponent_data(game_id, team_id)
      ...
      [matchup.our_abbrev, matchup.opponent_abbrev, Nhl::EdgeClient.fetch_team_skating_speed_detail(matchup.opponent_team_id, game_id: game_id)]
    end
